...
public final class HomingSystem {
    ...
    public static final TranslatableComponent TEXT_SELECTED_OPTION_TITLE = new TranslatableComponent(HOMING_SYS_PREFIX + "selected_option.title");
    public static final TranslatableComponent TEXT_SELECTED_OPTION_TARGET_TYPE = new TranslatableComponent(HOMING_SYS_PREFIX + "selected_option.target_type");
    public static final TranslatableComponent TEXT_SELECTED_OPTION_MODE = new TranslatableComponent(HOMING_SYS_PREFIX + "selected_option.mode");
    public static final TranslatableComponent TEXT_SELECTED_OPTION_RANGE = new TranslatableComponent(HOMING_SYS_PREFIX + "selected_option.range");
    public static final TranslatableComponent TEXT_SELECTED_OPTION_APERTURE = new TranslatableComponent(HOMING_SYS_PREFIX + "selected_option.aperture");
    public static final TranslatableComponent TEXT_TARGET_TYPE_TITLE = new TranslatableComponent(HOMING_SYS_PREFIX + "target_type.title");
    public static final TranslatableComponent TEXT_TARGET_TYPE_NONE = new TranslatableComponent(HOMING_SYS_PREFIX + "target_type.none");
    public static final TranslatableComponent TEXT_TARGET_TYPE_HOSTILE = new TranslatableComponent(HOMING_SYS_PREFIX + "target_type.hostile");
    public static final TranslatableComponent TEXT_TARGET_TYPE_PLAYER = new TranslatableComponent(HOMING_SYS_PREFIX + "target_type.player");
    public static final TranslatableComponent TEXT_TARGET_TYPE_ALL = new TranslatableComponent(HOMING_SYS_PREFIX + "target_type.all");
    public static final TranslatableComponent TEXT_MODE_TITLE = new TranslatableComponent(HOMING_SYS_PREFIX + "mode.title");
    public static final TranslatableComponent TEXT_MODE_LINE = new TranslatableComponent(HOMING_SYS_PREFIX + "mode.line");
    public static final TranslatableComponent TEXT_MODE_RANGED = new TranslatableComponent(HOMING_SYS_PREFIX + "mode.ranged");
    public static final TranslatableComponent TEXT_RANGE_TITLE = new TranslatableComponent(HOMING_SYS_PREFIX + "range.title");
    public static final TranslatableComponent TEXT_APERTURE_TITLE = new TranslatableComponent(HOMING_SYS_PREFIX + "aperture.title");
    public static final TranslatableComponent TEXT_EXTENT_SMALL = new TranslatableComponent(HOMING_SYS_PREFIX + "extent.small");
    public static final TranslatableComponent TEXT_EXTENT_MEDIUM = new TranslatableComponent(HOMING_SYS_PREFIX + "extent.medium");
    public static final TranslatableComponent TEXT_EXTENT_LARGE = new TranslatableComponent(HOMING_SYS_PREFIX + "extent.large");
    public static final TranslatableComponent TEXT_EXTENT_XLARGE = new TranslatableComponent(HOMING_SYS_PREFIX + "extent.xlarge");
    public static final TranslatableComponent TEXT_NO_INFO = new TranslatableComponent(HOMING_SYS_PREFIX + "no_info");
    public static Map<Byte, TranslatableComponent> SELECTED_OPTION_TEXT = new HashMap<>();
    public static Map<Byte, TranslatableComponent> TARGET_TYPE_TEXT = new HashMap<>();
    public static Map<Byte, TranslatableComponent> MODE_TEXT = new HashMap<>();
    public static Map<Byte, TranslatableComponent> EXTENT_TEXT = new HashMap<>();
